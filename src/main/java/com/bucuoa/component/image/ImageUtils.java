package com.bucuoa.component.image;
...
public final class ImageUtils {
	 ...
	 *            透明度(0.0 -- 1.0, 0.0为完全透明，1.0为完全不透明)
	 */
	public static void pressText(String srcImage,String targetImg, String pressText, String fontName, int fontStyle, int fontSize,
